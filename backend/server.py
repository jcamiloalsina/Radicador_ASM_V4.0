...
VERIFICACION_BASE_URL = os.environ.get('VERIFICACION_URL', 'https://prop-registry.preview.emergentagent.com')
...
def get_email_template(titulo: str, contenido: str, radicado: str = None, tipo_notificacion: str = "info", boton_texto: str = None, boton_url: str = None) -> str:
    ...
    """
    frontend_url = os.environ.get('FRONTEND_URL', 'https://prop-registry.preview.emergentagent.com')
