...
import { ArrowLeft, Save, Mail, Phone, MapPin, FileText, Calendar, Upload, Download, UserPlus, X, XCircle, CheckCircle, Paperclip, Send, RefreshCw, Search, Building, UserCheck, User } from 'lucide-react';
...
export default function PetitionDetail() {
  ...
  const [showGestorList, setShowGestorList] = useState(false); // Mostrar lista desplegable
