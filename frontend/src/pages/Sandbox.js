...
export default function Sandbox() {
  ...
  // Estados para plantillas de resolución
  ...
  // ===== Funciones para Plantillas de Resolución =====
  const cargarPlantillas = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        // Seleccionar M1 por defecto si existe
        const m1 = response.data.plantillas.find(p => p.tipo === 'M1');
        if (m1 && !plantillaSeleccionada) {
          seleccionarPlantilla(m1);
        }
      }
    } catch (error) {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Tab: Resoluciones */}
      {activeTab === 'resoluciones' && (
        <div className="bg-white rounded-xl shadow-sm p-6" data-testid="resoluciones-tab-content">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-amber-800">
                    ...
                    <ul className="mt-2 space-y-1">
                      ...
                      <li><code>{'{codigo_catastral}'}</code></li>
                      <li><code>{'{npn}'}</code></li>
                      <li><code>{'{municipio}'}</code></li>
                      <li><code>{'{vigencia_fiscal}'}</code></li>
                      <li><code>{'{fecha_resolucion_texto}'}</code></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-2">
                      El encabezado y pie de página son fijos. Las tablas de cancelación/inscripción se generan automáticamente.
                    </p>
                  </div>
                  ...
                  {pdfPreviewUrl && (
                    <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                      <div className="flex items-center gap-2 text-green-700">
                        ...
                        <span className="font-medium">Preview generado</span>
                        <a
                          href={pdfPreviewUrl}
                          target="_blank"
