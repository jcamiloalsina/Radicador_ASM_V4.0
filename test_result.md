...
- **Frontend URL**: https://cache-sync-fix.preview.emergentagent.com
- **Backend API**: https://cache-sync-fix.preview.emergentagent.com/api
...
**Credentials Verified:**
- ✅ Admin: catastro@asomunicipios.gov.co / Asm*123* - WORKING
- ✅ API Base URL: https://cache-sync-fix.preview.emergentagent.com - WORKING
